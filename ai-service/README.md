...
### 5.4 `POST /ai/generate-print-layout`
...
## 6. upload-debug 接口说明（仅用于本地调试）

### 6.1 `POST /ai/detect-upload`
...
### 6.2 `POST /ai/generate-id-photo-upload`
...
### 6.3 `POST /ai/generate-print-layout-upload`
