...
def test_natural_closed_mouth_expression_is_passed():
    ...
    svc._detect_expression_via_mesh = lambda image, face_box: (
        'neutral',
        {'mouth_open_ratio': 0.09, 'tongue_pixel_ratio': 0.01, 'mouth_corner_rise': 0.03, 'mouth_asymmetry': 0.02},
    )
    svc._detect_neck_accessory = lambda image, face_box: (0.0, {})
...
def test_obvious_mouth_open_expression_is_failed():
    ...
    svc._detect_expression_via_mesh = lambda image, face_box: (
        'mouth_open_fail',
        {'mouth_open_ratio': 0.37, 'tongue_pixel_ratio': 0.03, 'mouth_corner_rise': 0.04, 'mouth_asymmetry': 0.05},
    )
    svc._detect_neck_accessory = lambda image, face_box: (0.0, {})
